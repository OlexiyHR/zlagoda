...
@WebServlet(urlPatterns = { "/regular-customer" }, loadOnStartup = 1)
public class AddRegularCustomerController extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public AddRegularCustomerController() {
    }
